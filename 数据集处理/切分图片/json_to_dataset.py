...
if __name__ == '__main__':
    jpgs_path   = "/App/cbw/TZY_AnBan_Segment/VOCdevkit_ori_big/VOC2007/JPEGImages"
    pngs_path   = "/App/cbw/TZY_AnBan_Segment/VOCdevkit_ori_big/VOC2007/SegmentationClass_test"
    ...
    # classes = ["_background_","inMask","outMask"]
    classes = ["_background_","egg","light","white"]
    count = os.listdir("/App/cbw/TZY_AnBan_Segment/VOCdevkit_ori_big/VOC2007/before") 
    os.makedirs(jpgs_path, exist_ok=True)
    os.makedirs(pngs_path, exist_ok=True)
    for i in range(0, len(count)):
        path = os.path.join("/App/cbw/TZY_AnBan_Segment/VOCdevkit_ori_big/VOC2007/before", count[i])
