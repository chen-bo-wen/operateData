...
if __name__ == '__main__':
    jpgs_path   = "json_to_dataset/JPEGImages"
    pngs_path   = "json_to_dataset/SegmentationClass" # 生成的 png 图像存放路径
    classes = ["_background_","egg","light","white"]
    count = os.listdir("json_to_dataset/before") 
    os.makedirs(pngs_path, exist_ok=True)
    for i in range(0, len(count)):
        path = os.path.join("json_to_dataset/before", count[i])
